...
#' #' cntr2bbx
#' #'
#' #' Simple wrapper that converts a centroid to a bbox. Useful for creating
#' #' ggplots at various zoom levels, or cropping to an area of interest based on a
#' #' focal point or centroid.
#' #'
#' #' @param cntr centroid
